...
var sourcetext = "Source: prices.json";
...
function init() {
    ...
    d3.json("assets/data/trades.json", function (data) {
        data = formatTrade(data);
        trades = data;
    });

    d3.json("assets/data/prices.json", function (data) {
...
function redraw() {
    ...
    var t = thegraph.append("g")
        ...
        .attr("xlink:href", function (d, i) {
            var symbolType = "";
            if (d.side === "BUY") {
                symbolType = "assets/images/UpArrow.png"
            }
            else if (d.side === "SELL") {
                symbolType = "assets/images/DownArrow.png"
            }
            return symbolType;
        })
        .attr("class", "symbol2")
